...
const sounds: Sound[] = [
    { id: 'rain', name: 'Rain', icon: '🌧️', audioUrl: '/sounds/rain.mp3' },
    { id: 'fireplace', name: 'Fireplace', icon: '🔥', audioUrl: '/sounds/fireplace.mp3' },
    { id: 'lofi', name: 'Lo-fi Beats', icon: '🎵', audioUrl: '/sounds/lofi-beats.mp3' },
    { id: 'library', name: 'Library', icon: '📚', audioUrl: '/sounds/library sounds.mp3' },
];
