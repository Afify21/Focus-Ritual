...
const App: React.FC = () => {
    ...
    const [useDesktopUI, setUseDesktopUI] = useState(false);
        ...
        <div className="min-h-screen text-white">
            {useDesktopUI ? (
                ...
                <>
                    ...
                    <button
                        onClick={() => setUseDesktopUI(!useDesktopUI)}
                        className="fixed left-4 bottom-4 px-4 py-2 rounded-lg bg-slate-600 hover:bg-slate-700 transition-colors"
                    >
                        Switch to {useDesktopUI ? 'Default' : 'Desktop'} UI
                    </button>
                </>
            )}
        </div>
